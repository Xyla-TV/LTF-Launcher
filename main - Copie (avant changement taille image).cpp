...
int main()
{
	...
	// Import icon
	if (!icon.loadFromFile("LTF/imgs/icon.png"))
	{
	...
	// Import images
	if (!backgroundTexture1.loadFromFile("LTF/imgs/background1.png"))
	{
	...
	if (!backgroundTexture2.loadFromFile("LTF/imgs/background2.png"))
	{
	...
	if (!backgroundTexture3.loadFromFile("LTF/imgs/background3.png"))
	{
	...
	if (!buttonHoveredTexture.loadFromFile("LTF/imgs/buttonHovered.png"))
	{
		std::cout << "Error : can't load buttonHovered.png" << std::endl;
	}

	if (!buttonUnhoveredTexture.loadFromFile("LTF/imgs/buttonUnhovered.png"))
	{
		std::cout << "Error : can't load buttonHovered.png" << std::endl;
	}
	...
	if (!smallButtonHoveredTexture.loadFromFile("LTF/imgs/smallButtonHovered.png"))
	{
		std::cout << "Error : can't load smallButtonHovered.png" << std::endl;
	}

	if (!smallButtonUnhoveredTexture.loadFromFile("LTF/imgs/smallButtonUnhovered.png"))
	{
	...
	if (!exitTexture.loadFromFile("LTF/imgs/exit.png"))
	{
	...
	if (!soundoffTexture.loadFromFile("LTF/imgs/soundoff.png"))
	{
		std::cout << "Error : can't load soundoff.png" << std::endl;
	}

	if (!soundonTexture.loadFromFile("LTF/imgs/soundon.png"))
	{
	...
	jeu1Sprite.setPosition(380, 150);
	...
	jeu2Sprite.setPosition(670, 150);
	...
	jeu3Sprite.setPosition(960, 150);
			...
			case sf::Event::MouseButtonPressed:
				{
					...
					{
						system("start LTF/manuels/manuel1.pdf");
						break;
					}

					if (manuel2Sprite.getGlobalBounds().contains(mousePosF))
					{
						system("start LTF/manuels/manuel2.pdf");
						break;
					}

					if (manuel3Sprite.getGlobalBounds().contains(mousePosF))
					{
						system("start LTF/manuels/manuel3.pdf");
						break;
					}
