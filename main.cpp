			...
			case sf::Event::MouseMoved:
				{
					...
					if (lancerJeu2Hover)
					{
						lancerJeu2Sprite.setTexture(jeuButtonHoveredTexture1);
					}
					else
					{
						lancerJeu2Sprite.setTexture(jeuButtonUnhoveredTexture1);
					}

					if (lancerJeu3Hover)
					{
						lancerJeu3Sprite.setTexture(jeuButtonHoveredTexture1);
					}
					else
					{
						lancerJeu3Sprite.setTexture(jeuButtonUnhoveredTexture1);
					}

					if (manuel1Hover)
					{
						manuel1Sprite.setTexture(jeuButtonHoveredTexture1);
					}
					else
					{
						manuel1Sprite.setTexture(jeuButtonUnhoveredTexture1);
					}

					if (manuel2Hover)
					{
						manuel2Sprite.setTexture(jeuButtonHoveredTexture1);
					}
					else
					{
						manuel2Sprite.setTexture(jeuButtonUnhoveredTexture1);
					}

					if (manuel3Hover)
					{
						manuel3Sprite.setTexture(jeuButtonHoveredTexture1);
					}
					else
					{
						manuel3Sprite.setTexture(jeuButtonUnhoveredTexture1);
					}
